...
class Map(QWidget):
    def __init__(self):
        ...
        self.pixel_dict = {
            ...
            # t
            '105': (270, 484), '106': (), '107': (), '108': (), '109': (326, 435),
            # u
            '110': (326, 419), '111': (326, 404), '112': (326, 388), '113': (326, 373), '114': (326, 357), '115': (326, 341), '116': (326, 332),
            # v
            '117': (326, 310), '118': (), '119': (), '120': (), '121': (),
            # w
            '122': (275, 247), '123': (265, 247), '124': (255, 247), '125': (246, 247), '126': (236, 247), '127': (226, 247), '128': (216, 247), '129': (207, 247), '130': (197, 247), '131': (187, 247), '132': (177, 247), '133': (168, 247), '134': (158, 247), '135': (148, 247), '136': (138, 247), '137': (128, 247), '138': (119, 247), '139': (109, 247), '140': (99, 247), '141': (89, 247), '142': (80, 247), '143': (70, 247),
            # x
            '144': (60, 247), '145': (), '146': (),
            # y
            '147': (), '148': (), '149': (20, 170),
