...
class LauncherUi(QMainWindow):
    ...
    open_track_controller_tb_ui_signal = pyqtSignal()
    ...
    def __init__(self):
        ...
        self.track_controller_testbench_button = self.findChild(QPushButton, 'track_controller_testbench_button')
        ...
        # Track Controller
        self.track_controller_testbench_button.clicked.connect(self.start_track_controller_tb_ui)
    ...
    def start_track_controller_tb_ui(self):
        self.open_track_controller_tb_ui_signal.emit()
        print("Track Controller TB button clicked")
